...
这是半导体制造系统智能调度课程设计的 Python 包。项目周期为 14 周，目前处于 `M1 — Simulation Reliability Baseline`：轻量 DES 已验证 MC01～MC06，包含 FIFO、显式 Setup、wafer 容量 Batch、主动 timeout、跨步 CQT、物理机 Dedication、逐事件 trace 与 provenance；MC07～MC08 和正式数据实验尚未实现，CMA-ES 在 M1 通过前禁用。
